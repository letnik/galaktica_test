// Імпорт таб-менеджера
import initTabs from './modules/tab-manager.js'

// Анімація для accent елементів
document.addEventListener('DOMContentLoaded', function() {
	// Ініціалізуємо таб-систему
	initTabs()
	
	// Знаходимо всі accent елементи
	const accentElements = document.querySelectorAll('.tab-panel__title-accent')
